    ...
    <>
     <Stack direction='row' gap={5} alignItems='center' onClick={handleOpen}>
        ...
        <Stack direction='column' >
            <Typography sx={{fontSize: '1.2rem'}} component='h6' fontWeight='Bold' color='white'>Alarm Sound</Typography>
            <Typography sx={{fontSize: '.9rem'}} component='h6' color='#aaaaaa'>Default ringtone (Fine Day)</Typography>
        </Stack> 
    </Stack>
    <Modal
        open={open}
